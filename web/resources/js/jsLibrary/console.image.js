(function (console) {
    ...
    var memes = {
        ...
        "herohero": "https://res.cloudinary.com/dhgrt80hq/image/upload/v1598257710/public/Group_11_lvfgos.png"
    };
    /**
...
//        console.log(url);
    ...
    console.image = function (url, scale) {
        ...
        img.onload = function () {
            ...
            console.log("%c" + dim.string, dim.style + "background: url(" + url + "); \n\
...
window.onload = function () {
    console.meme("Estás aquí para estudiar mi código", "o solo quieres hackearme", "herohero", 400, 300);
//    clear = function () {
//        console.meme("Estás aquí para estudiar mi código", "o solo quieres hackearme", "herohero", 400, 300);
//    };
//    console.clear = clear;
